...
const EVENT_BADGE_COLORS: Record<AuditEventType, string> = {
  ...
  recovery_queued: "bg-blue-100 text-blue-800",
  recovery_started: "bg-indigo-100 text-indigo-800",
  recovery_paused: "bg-amber-100 text-amber-800",
  recovery_resumed: "bg-cyan-100 text-cyan-800",
              ...
              {filteredEvents.map((event) => (
                ...
                >
                  ...
                  <td className="px-4 py-3">
                    <span
                      className={cn(
                        "inline-flex min-w-[5.5rem] items-center justify-center rounded-full px-2 py-0.5 text-xs font-medium whitespace-nowrap",
